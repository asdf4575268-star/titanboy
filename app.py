        ...
        if acts:
            if mode == "DAILY":
                ...
                if weekly_data:
                    ...
                    f_day = dt_t.replace(day=1)
                    adj_dom = dt_t.day + f_day.weekday()
                    w_num = (adj_dom - 1) // 7 + 1
                    sfx = "TH" if 11 <= w_num <= 13 else {1: "ST", 2: "ND", 3: "RD"}.get(w_num % 10, "TH")
                    
                    # WEEKLY: "6TH WEEK" 만 표시
